         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-md-5 text-center"><img class="img-fluid" src="<?php echo e(asset('assets/images/ecommerce/card.png')); ?>" alt=""></div>
               </div>
            </div>
         </div>
      </div>
               ...
               <form class="theme-form row">
                  ...
                  <div class="mb-3 col-12">
                     <ul class="payment-opt">
                        <li><img src="<?php echo e(asset('assets/images/ecommerce/mastercard.png')); ?>" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/images/ecommerce/visa.png')); ?>" alt=""></li>
                        <li><img src="<?php echo e(asset('assets/images/ecommerce/paypal.png')); ?>" alt=""></li>
                     </ul>
                  </div>
                  <div class="col-12">
                     <button class="btn btn-primary btn-block" type="button" title="">Submit</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/apps/payment-details.blade.php ENDPATH**/ ?>