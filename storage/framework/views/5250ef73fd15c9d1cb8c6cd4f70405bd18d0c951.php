			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('categories.update',$category->id)); ?>" class="theme-form mega-form">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gile/laravel-projects/a4energy2/resources/views/categories/forms/edit.blade.php ENDPATH**/ ?>