  ...
  <div class="row tilt-showcase">
          ...
          <div class="row">
            <div class="col-md-6 offset-md-3">
              ...
              <div>
                ...
                <ul>
                  <li>
                    <div class="line"><code><span> &lt;script src=&quot;&#123;&#123;asset('tilt.jquery.js')&#125;&#125;&quot;&gt;&lt;/script&gt;</span></code></div>
                  </li>
                  <li>
    ...
    <div class="col-xl-4 col-lg-6">
      <div class="card height-equal">
        ...
        <div class="card-body">
          <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?php echo e(asset('assets/images/lightgallry/04.jpg')); ?>" data-tilt-glare="true" data-tilt-maxglare=".5" data-tilt-perspective="200" data-tilt-speed="300" data-tilt-max="10" alt=""></div>
          <div>
            <h6 class="sub-title mt-4">How to Use:</h6>
            <div class="line">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/animation/tilt.blade.php ENDPATH**/ ?>