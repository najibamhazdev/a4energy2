      ...
      <div class="col-sm-12 col-xl-12">
         <div class="card">
            ...
            <div class="card-body dropdown-basic">
               ...
               <div class="dropdown">
                  <div class="btn-group mb-0">
                     <button class="dropbtn btn-secondary" type="button">Action <span><i class="icofont icofont-arrow-down"></i></span></button>
                     <div class="dropdown-content">
                        <a href="#">Action</a><a href="#">Another Action</a><a href="#">Something Else Here</a>
                        <div class="dropdown-divider"></div>
                        <a href="#">Separated Link </a>
               ...
               <div class="dropdown">
                  <div class="btn-group mb-0">
                     <button class="dropbtn btn-info" type="button">Action <span><i class="icofont icofont-arrow-down"></i></span></button>
                     <div class="dropdown-content">
                        <a href="#">Action</a><a href="#">Another Action</a><a href="#">Something Else Here</a>
                        <div class="dropdown-divider"></div>
                        <a href="#">Separated Link </a>
               ...
               <div class="dropdown">
                  <div class="btn-group mb-0">
                     <button class="dropbtn btn-warning txt-dark" type="button">Action <span><i class="icofont icofont-arrow-down"></i></span></button>
                     <div class="dropdown-content">
                        <a href="#">Action</a><a href="#">Another Action</a><a href="#">Something Else Here</a>
                        <div class="dropdown-divider"></div>
                        <a href="#">Separated Link </a>
               ...
               <div class="dropdown">
                  <div class="btn-group mb-0">
                     <button class="dropbtn btn-danger" type="button">Action <span><i class="icofont icofont-arrow-down"></i></span></button>
                     <div class="dropdown-content">
                        <a href="#">Action</a><a href="#">Another Action</a><a href="#">Something Else Here</a>
                        <div class="dropdown-divider"></div>
                        <a href="#">Separated Link </a>
            ...
            <div class="card-body dropdown-basic">
               <div class="btn-group">
                  ...
                  <div class="dropdown separated-btn">
                     ...
                     <div class="dropdown-content digits"><a href="#">Link 1</a><a href="#">Link 2</a><a href="#">Link 3</a></div>
                  </div>
               </div>
               <div class="btn-group">
         ...
         <div class="card">
            ...
            <div class="card-body dropup-basic">
               <div class="dropup">
                  ...
                  <div class="dropup-content"><a href="#">Normal</a><a class="active" href="#">Active</a><a class="disabled" href="#">Disabled</a></div>
               </div>
            </div>
         </div>
      </div>
      <div class="col-sm-12 col-xl-6">
         <div class="card">
            ...
            <div class="card-body dropup-basic">
               <div class="dropup">
                  <button class="dropbtn btn-primary" type="button">Dropdown Button <span><i class="icofont icofont-arrow-up"></i></span></button>
                  <div class="dropup-content"><a href="#">Link 1</a><a href="#">Link 2</a></div>
               </div>
            </div>
         </div>
      </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/ui-kits/dropdown.blade.php ENDPATH**/ ?>