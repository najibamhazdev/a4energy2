					...
					<form>
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								...
								<input class="form-control is-invalid" id="validationServer03" type="text" required="">
								<div class="invalid-feedback">Please provide a valid city.</div>
							</div>
							<div class="col-md-3 mb-3">
							...
							<div class="col-md-3 mb-3">
								...
								<input class="form-control is-invalid" id="validationServer05" type="text" required="">
								<div class="invalid-feedback">Please provide a valid zip.</div>
							</div>
						</div>
						<div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/forms/form-validation.blade.php ENDPATH**/ ?>