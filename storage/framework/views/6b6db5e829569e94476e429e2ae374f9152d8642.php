<?php $__env->startSection('title', 'Edit Record'); ?>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('cigarettes.update',$cigarette->id)); ?>" class="theme-form mega-form">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <input class="form-control" type="text" name="name" value="<?php echo e($cigarette->name); ?>" placeholder="your Name">
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gile/laravel-projects/a4energy2/resources/views/cigarettes/forms/edit.blade.php ENDPATH**/ ?>