			...
			<div class="card">
				...
				<div class="card-body">
					...
					<ul class="nav nav-tabs border-tab" id="bottom-tab" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" id="profile-bottom-tab" data-bs-toggle="tab" href="#bottom-profile" role="tab" aria-controls="bottom-profile" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Profile</a>
							<div class="material-border"></div>
						</li>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/ui-kits/tab-material.blade.php ENDPATH**/ ?>