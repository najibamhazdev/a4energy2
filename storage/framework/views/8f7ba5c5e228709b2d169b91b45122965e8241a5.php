...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                  ...
                  <div class="card" id="custom-state-button">
                        ...
                        <div class="card-body btn-showcase">
                              <a class="btn btn-primary" href="#" data-bs-toggle="tooltip" title="btn btn-primary" role="button">Link</a>
                              <input class="btn btn-secondary" type="button" value="Input" data-bs-toggle="tooltip" title="btn btn-secondary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gile/laravel-projects/a4energy2/resources/views/buttons/buttons.blade.php ENDPATH**/ ?>