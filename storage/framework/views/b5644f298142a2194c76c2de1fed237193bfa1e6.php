<?php $__env->startSection('title', 'Image Cropper'); ?>

<?php $__env->startSection('css'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/image-cropper.css')); ?>">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-xl-9 col-md-12">
								<div class="img-container"><img id="image" src="../assets/images/other-images/img-cropper.jpg" alt="Picture"></div>
							</div>
							<div class="col-xl-3 col-md-12">
								...
								<div class="docs-data">
									...
									<div class="input-group input-group-sm"><span class="input-group-text" for="dataHeight">Height </span>
										<input class="form-control" id="dataHeight" type="text" placeholder="height"><span class="input-group-text">px</span>
									</div>
									<div class="input-group input-group-sm"><span class="input-group-text" for="dataRotate">Rotate</span>
										<input class="form-control" id="dataRotate" type="text" placeholder="rotate"><span class="input-group-text">deg</span>
									</div>
									<div class="input-group input-group-sm"><span class="input-group-text" for="dataScaleX">ScaleX</span>
										<input class="form-control" id="dataScaleX" type="text" placeholder="scaleX">
									</div>
									<div class="input-group input-group-sm"><span class="input-group-text" for="dataScaleY">ScaleY</span>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="img-container"><img class="crop-zoomable img-fluid" src="../assets/images/other-images/img-cropper.jpg" alt=""></div>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="img-container"><img class="crop-auto img-fluid" src="../assets/images/other-images/img-cropper.jpg" alt=""></div>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="img-container"><img class="crop-drag img-fluid" src="../assets/images/other-images/img-cropper.jpg" alt=""></div>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="img-container"><img class="crop-min img-fluid" src="../assets/images/other-images/img-cropper.jpg" alt=""></div>
							</div>
						</div>
					</div>
				</div>
...
<script src="<?php echo e(asset('assets/js/image-cropper/cropper.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/image-cropper/cropper-main.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/bonus-ui/image-cropper.blade.php ENDPATH**/ ?>