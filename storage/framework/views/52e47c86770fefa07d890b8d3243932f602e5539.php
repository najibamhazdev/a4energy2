                  ...
                  <div>
                     <div>
                        <div class="row">
                           <div class="col-sm-6">
                              <div class="media">
                                 <div class="media-left"><img class="media-object img-60" src="<?php echo e(asset('assets/images/other-images/logo-login.png')); ?>" alt=""></div>
                     ...
                     <div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <form class="text-end">
                                 <input type="image" src="<?php echo e(asset('assets/images/other-images/paypal.png')); ?>" name="submit" alt="PayPal - The safer, easier way to pay online!">
                              </form>
                           </div>
                        </div>
                     </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Desktop/hetvi/laravel/Cuba/resources/views/apps/invoice-template.blade.php ENDPATH**/ ?>