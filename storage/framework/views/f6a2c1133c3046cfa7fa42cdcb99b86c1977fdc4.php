              ...
              <table class="table table-bordernone">
                <tbody class="f-w-500">
                  <tr>
                    <td>
                      <div class="media">
                        <img class="img-fluid m-r-15 rounded-circle" src="<?php echo e(asset('assets/images/dashboard-2/product-1.png')); ?>" alt="">
                        <div class="media-body">
                  ...
                  <tr>
                    <td>
                      <div class="media">
                        <img class="img-fluid m-r-15 rounded-circle" src="<?php echo e(asset('assets/images/dashboard-2/product-3.png')); ?>" alt="">
                        <div class="media-body">
                          <span>Tree Pot</span>
                  ...
                  <tr>
                    <td>
                      <div class="media">
                        <img class="img-fluid m-r-15 rounded-circle" src="<?php echo e(asset('assets/images/dashboard-2/product-4.png')); ?>" alt="">
                        <div class="media-body">
                          <span>Bag</span>
                  ...
                  <tr>
                    <td>
                      <div class="media">
                        <img class="img-fluid m-r-15 rounded-circle" src="<?php echo e(asset('assets/images/dashboard-2/product-5.png')); ?>" alt="">
                        <div class="media-body">
                          <span>Wtach</span>
                  ...
                  <tr>
                    <td>
                      <div class="media">
                        <img class="img-fluid m-r-15 rounded-circle" src="<?php echo e(asset('assets/images/dashboard-2/product-6.png')); ?>" alt="">
                        <div class="media-body">
                          <span>T-shirt</span>
                    ...
                    <div class="carousel-item active">
                      <div class="selling-slide row">
                        ...
                        <div class="col-xl-4 col-md-12">
                          <div class="center-img"><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard-2/offer-shoes-3.png')); ?>" alt="..."></div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                          <div class="d-flex">
                    ...
                    <table class="table table-bordernone">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <div class="d-inline-block align-middle">
                              <img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="">
                              <div class="status-circle bg-primary"></div>
                              <div class="d-inline-block">
                        ...
                        <tr>
                          <td>
                            <div class="d-inline-block align-middle">
                              <img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo e(asset('assets/images/avtar/16.jpg')); ?>" alt="">
                              <div class="status-circle bg-primary"></div>
                              <div class="d-inline-block">
                                <span>loain deo</span>
                                <p class="font-roboto">2020</p>
                        ...
                        <tr>
                          <td>
                            <div class="d-inline-block align-middle">
                              <img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo e(asset('assets/images/avtar/11.jpg')); ?>" alt="">
                              <div class="status-circle bg-primary"></div>
                              <div class="d-inline-block">
                        ...
                        <tr>
                          <td>
                            <div class="d-inline-block align-middle">
                              <img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo e(asset('assets/images/avtar/3.jpg')); ?>" alt="">
                              <div class="status-circle bg-primary"></div>
                              <div class="d-inline-block">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prajit/Downloads/wetransfer_updated_cuba-zip_2022-07-13_0950/updated_cuba/Laravel/Cuba/resources/views/dashboard/dashboard-02.blade.php ENDPATH**/ ?>