								...
								<table class="table table-bordered checkbox-td-width">
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="mb-3 m-b-0 m-checkbox-inline">
								...
								<table class="table table-bordered checkbox-td-width">
									<tbody>
										...
										<tr>
											...
											<td>
												<select class="form-select" id="exampleFormControlSelect22" multiple="">
													<option>1</option>
													<option>2</option>
													<option>3</option>
													<option>4</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gile/laravel-projects/a4energy2/resources/views/tables/table-components.blade.php ENDPATH**/ ?>